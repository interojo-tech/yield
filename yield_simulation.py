...
def main() -> None:
    ...
    def _load_and_prepare(path: str) -> pd.DataFrame:
        ...
        # Filter out any records where the process is '몰드인쇄'.  Removing
        # this process ensures that it does not appear in the sidebar
        # selection or in any yield or production charts.  No other
