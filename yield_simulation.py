...
def main() -> None:
    ...
    def _load_and_prepare(path: str) -> pd.DataFrame:
        ...
        # Exclude processes related to 몰드인쇄/몰드인자.  These records
        # represent mold printing and should not be included in the yield
        # analysis.  Match on any process name containing "몰드" to ensure
        # variants such as "몰드인쇄" or "몰드인자" are removed.
        if "Process" in df_local.columns:
            df_local = df_local[~df_local["Process"].astype(str).str.contains("몰드", na=False)]
