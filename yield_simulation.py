    ...
    if st:
            ...
            try:
                ...
                for idx_val in weekly_summary.index:
                    ...
                    if isinstance(key, tuple) and len(key) > 0:
                        key = key[0]
                    # Extract the first integer substring from the key
        ...
        def draw_combined_chart(combined_df: pd.DataFrame, title: str, xlabel: str) -> None:
            ...
            if USE_PLOTLY:
                ...
                # Left y-axis for yield (%) with fixed range 80–100 and black labels/title and tick labels
                fig.update_yaxes(
                    title_text='수율 (%)',
                    title_font=dict(color='black'),
                    secondary_y=False,
                ...
                # Constrain yield axis to 80–100 to align with other yield charts
                ax_yield.set_ylim(80, 100)
