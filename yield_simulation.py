    ...
    if st:
        ...
        def draw_product_chart(pivot_df: pd.DataFrame, title: str, xlabel: str) -> None:
            ...
            if USE_PLOTLY:
                ...
                # through the palette.
                fig.update_layout(legend_title_text="제품군", colorway=COLOR_PALETTE)
        ...
        def draw_combined_chart(combined_df: pd.DataFrame, title: str, xlabel: str) -> None:
            ...
            if USE_PLOTLY:
                ...
                # Use the global colour palette for yield lines.  We slice
                # to the first four colours as this chart has four yield
                # traces (A관, C관, S관, 종합수율).  The palette ensures
                # consistent styling across all charts.
                line_colors = COLOR_PALETTE[:4]
                ...
                # Use the global colour palette for yield lines (first four colours).
                line_colors = COLOR_PALETTE[:4]
                for col, color in zip(['A관', 'C관', 'S관', '종합수율'], line_colors):
