...
def main() -> None:
    ...
    if st:
        ...
        st.markdown(
            """
            <style>
            /* Style each radio option as a box with larger font.  Target the
               radiogroup labels specifically to avoid applying the style
               globally to all labels. */
            ...
            /* Remove the default border and background on the radio container */
            .dashboard-radio {
                margin-bottom: 20px;
            }
            /* Adjust header text sizes.  The main-header is reduced slightly
               compared to the previous version to meet the new requirements. */
            .main-header {
                font-size: 32px;
                font-weight: 700;
                margin-bottom: 4px;
