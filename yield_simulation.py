...
def main() -> None:
    ...
    if st:
        ...
        # Read the last modified time of the selected Excel file.  If an
        # exception occurs (e.g., file not found), fall back to zero so
        # Streamlit will still compute a cache key.
        try:
