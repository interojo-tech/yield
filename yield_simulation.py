...
def main() -> None:
    ...
    if st:
        ...
        def summarise_and_percent(
            ...
            # Perform this before converting to percentage so the mean is computed on raw yields.
        ...
        with tab_daily:
            ...
            # the index to datetime for sorting, then take the tail.  If the
            # summary is empty or conversion fails, fall back to the original.
        ...
        with tab_weekly:
            ...
            if selected_date_weekly == '전체':
                ...
                # Build a week key in the same format as the weekly_summary index (e.g., 'W2', 'W3').
