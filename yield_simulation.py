...
def main() -> None:
    ...
    def _load_and_prepare(path: str) -> pd.DataFrame:
        ...
        # Remove all records corresponding to the '몰드인쇄' process.  This
        # deletion ensures that the yield dashboard does not display
        # '몰드인쇄' in the sidebar or any charts.  Filter the
        # DataFrame before deriving additional date columns.
