...
# Define a global process order constant used throughout the dashboard.  This list
# controls the order in which processes appear in tables, charts and KPI panels.
PROCESS_ORDER = [
    "사출조립",
    "분리",
    "하이드레이션/전면검사",
...
def main() -> None:
    ...
    if st:
        ...
        overall_yield = 1.0
        # Use the global process order to compute the overall yield.  Copy the
        # constant list here so any modifications do not affect the module
        # constant.  Missing processes default to a yield of 1.0.
