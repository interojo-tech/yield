...
def main() -> None:
    ...
    if st:
        ...
        with tab_daily:
            ...
            # Display product summary for the selected plant and filters
        ...
        # The summary groups records by defect classification and summarises
        # production quantity, good quantity and yield percentage.  This summary
        # will be displayed in each time‑period tab (일별, 주간, 월별) below.
        prod_group = "신규분류요약"
        product_summary_df = (
