...
def main() -> None:
    ...
    if st:
        ...
        # Fix the yield y‑axis range for all charts.  The slider has
        # been removed so there is no user control over this range.
        # Set to match the previous default of 50–100.
